...
BOARD_EGL_CFG := device/htc/golfu/configs/egl.cfg
...
TARGET_RECOVERY_INITRC := device/htc/golfu/files/init.recovery.rc
BOARD_CUSTOM_GRAPHICS  := ../../../device/htc/golfu/recovery/graphics.c
...
BOARD_CUSTOM_USB_CONTROLLER := ../../device/htc/golfu/UsbController.cpp
BOARD_UMS_LUNFILE := "/sys/devices/platform/msm_hsusb/gadget/lun0/file"

# Yet to be set for golfu
